...
// use defined interrupt
static void myUartHandler(void);
static void gpioc_handler(void);
static void SysTick_Handler(void);


// end user defined interrupts.
